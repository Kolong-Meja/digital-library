...
@stop
@section('description')
    For manage roles data.
@stop
<x-app-layout>
    @section('content')
        <div class="min-h-screen bg-gray-900">
            {{-- Create Role Modal --}}
            @include('components.role.create-role-modal')

            {{-- Update Role Modal --}}
            @include('components.role.update-role-modal')
                            ...
                            <div class="p-6 text-gray-100">
                                ...
                                <div class="flex flex-row space-x-4 mb-4">
                                    ...
                                    <div id="dropdownRadioHelper" class="z-10 hidden shadow-xl bg-gray-700 rounded-lg w-60">
                                        <form autocomplete="on" action="{{ route('role.index') }}" method="GET" id="roleSearchForm" class="border-b border-gray-600">
                                            <div class="p-3">
                                                <div class="relative">
                                        ...
                                        <form class="mt-2" autocomplete="on" action="{{ route('role.index') }}" method="GET" id="roleFilterForm">                                       
                                            </ul>
                                            <div class="flex items-center justify-center">
                                                <p class="text-sm font-semibold">Or filter by status</p>
                                            </div>
                                            <ul 
                                            id="roleStatusOrderFilter"
                                            class="
                                            p-3 
                                            space-y-1 
                                            text-sm 
                                                ...
                                                <li>
                                                    <div class="flex p-2 rounded hover:bg-gray-600">
                                                        ...
                                                        <div class="ms-2 text-sm">
                                                            <label for="order-role-deprecated" class="font-medium text-gray-100">deprecated</label>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex p-2 rounded hover:bg-gray-600">
                                                        ...
                                                        <div class="ms-2 text-sm">
                                                            <label for="order-role-active" class="font-medium text-gray-100">active</label>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <tbody>
                                            @forelse ($roles as $role)
                                                ...
                                                >
                                                    ...
                                                    <td class="px-6 py-4">
                                                        @php
                                                            $statusAreaClass = ($role->status === 'deprecated') 
                                                            ? "
                                                            relative 
                                                            flex 
                                                            items-center 
                                                            ...
                                                            $pingStatusClass = ($role->status === "deprecated") 
                                                            ? "
                                                            animate-ping 
                                                            absolute 
                                                            inline-flex 
                                                            ...
                                                            $circleDotStatusClass = ($role->status === "deprecated")
                                                            ? "
                                                            relative 
                                                            inline-flex 
                                                            rounded-full 
                                                        ...
                                                        <span class="{{ $statusAreaClass }}">
                                                            ...
                                                            <span class="ml-1">{{ $role->status }}</span>
                                                        </span>
                                                    </td>                                                  
                                                    <td class="px-6 py-4">
                                                        {{ $role->updated_at }}
                                            ...
                                            @empty
                                                ...
                                                >
                                                    ...
                                                    <span class="sr-only">Info</span>
                                                    <div class="text-sm">
                                                        <span class="font-bold">Danger alert!</span> Roles table is empty, please create new one.
                                                    </div>
                                                </div>
                                            @endforelse
                                        </tbody>
