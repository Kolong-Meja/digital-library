...
@stop
@section('description')
    For manage users data.
@stop
<x-app-layout>
    @section('content')
        <div class="min-h-screen bg-gray-900">
            {{-- Create Role Modal --}}
            @include('components.user.create-user-modal')

            {{-- Update Role Modal --}}
            @include('components.user.update-user-modal')
                            ...
                            <div class="p-6 text-gray-100">
                                ...
                                <div class="flex flex-row space-x-4 mb-4">
                                    ...
                                    <div id="dropdownRadioHelper" class="z-10 hidden shadow-xl bg-gray-700 rounded-lg w-60">
                                        <form autocomplete="on" action="{{ route('user.index') }}" method="GET" id="userSearchForm" class="border-b border-gray-600">
                                            <div class="p-3">
                                                <div class="relative">
                                        ...
                                        <form class="mt-2" autocomplete="on" action="{{ route('user.index') }}" method="GET" id="userFilterForm">                                       
                                            </ul>
                                            <div class="flex items-center justify-center">
                                                <p class="text-sm font-semibold">Or filter by status</p>
                                            </div>
                                            <ul 
                                            id="userStatusOrderFilter"
                                            class="
                                            p-3 
                                            space-y-1 
                                            text-sm 
                                                ...
                                                <li>
                                                    <div class="flex p-2 rounded hover:bg-gray-600">
                                                        ...
                                                        <div class="ms-2 text-sm">
                                                            <label for="order-role-offline" class="font-medium text-gray-100">offline</label>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex p-2 rounded hover:bg-gray-600">
                                                        ...
                                                        <div class="ms-2 text-sm">
                                                            <label for="order-user-online" class="font-medium text-gray-100">online</label>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                    ...
                                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            ...
                                            >
                                                ...
                                                <td class="px-6 py-4">
                                                    @php
                                                        $statusAreaClass = ($user->status !== 'online') 
                                                        ? "
                                                        relative 
                                                        flex 
                                                        items-center 
                                                        ...
                                                        $pingStatusClass = ($user->status !== "online") 
                                                        ? "
                                                        animate-ping 
                                                        absolute 
                                                        inline-flex 
                                                        ...
                                                        $circleDotStatusClass = ($user->status !== "online")
                                                        ? "
                                                        relative 
                                                        inline-flex 
                                                        rounded-full 
                                            ...
                                            @empty
                                                ...
                                                >
                                                    ...
                                                    <span class="sr-only">Info</span>
                                                    <div class="text-sm">
                                                        <span class="font-bold">Danger alert!</span> Users table is empty, please create new one.
                                                    </div>
                                                </div>
                                            @endforelse
                                        </tbody>
